...
const FEATURED_GIFTS: SympathyGiftProduct[] = [
  {
    id: 1,
    name: "Peace Lily",
    price: 75.00,
    ...
    description: "A living expression of sympathy and remembrance. Lush evergreen foliage with elegant white blooms that flourish indoors.",
  ...
  },
  {
    ...
    description: "A comforting reminder of a life that will always be remembered. Hand-poured soy wax with customized name & memory dates.",
  ...
  },
  {
    ...
    reviewsCount: 31,
    badge: "Archival Wood",
    description: "Keep a treasured memory close. Hand-finished mahogany photo frame inscribed with 'Always in Our Hearts'.",
  ...
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 37,
    badge: "Sustained Resonant Tone",
    description: "A gentle reminder of love, memories and enduring connection. Aluminum tubes hand-tuned to deep soothing tones.",
    purpose: "Peace & Comfort"
  },
  {
    id: 5,
    ...
    rating: 4.9,
    reviewsCount: 26,
    badge: "Solid Walnut Wood",
    description: "A special place for photographs, letters and treasured memories. Lined in plush velvet with laser-etched family name.",
    purpose: "Personalized",
    isPersonalizable: true
  },
  {
    ...
    rating: 5.0,
    reviewsCount: 49,
    badge: "Fresh Hand-Tied Blooms",
    description: "A traditional and beautiful expression of care. Soft pastel roses, white lilies, and eucalyptus arranged in a woven wicker basket.",
    purpose: "Thinking of You"
  },
  {
    id: 7,
    name: "Sterling Silver Ashes Locket",
    price: 180.00,
    category: "Keepsakes",
    ...
    description: "A comforting keepsake worn close to the heart, containing a discreet inner chamber and laser-engraved initials.",
    purpose: "Memory Lives On",
    isPersonalizable: true
  },
  {
    id: 8,
    name: "Handwritten Sympathy Card Set",
    price: 20.00,
    ...
    description: "Heavy cotton letterpress card printed with metallic gold accents. Custom calligraphy message included upon request.",
    purpose: "Thinking of You"
  },
  {
    id: 9,
    name: "Succulent Memory Garden Bowl",
    price: 65.00,
    category: "Plants & Garden",
    image: "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=600&q=80",
    rating: 4.7,
    reviewsCount: 19,
    badge: "Evergreen Comfort",
    description: "Arrangement of low-maintenance evergreen succulents in a ceramic memory dish with polished river stones.",
    purpose: "Peace & Comfort"
  }
];
